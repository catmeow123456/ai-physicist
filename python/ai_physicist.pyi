...
class Knowledge:
    ...
    def eval_objattr(self, objattrexp: ObjAttrExp, objsettings: List[Objstructure]) -> ConstData: ...
    ...
    def generalize_sexp(self, sexp: SExp) -> TExp: ...
    def generalize(self, expr: Exp, exp_name: str) -> TExp: ...
    def specialize(self, texp: TExp, exp_name: str) -> List[Exp]: ...
